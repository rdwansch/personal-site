      ...
      <div class="space-y-0 divide-y divide-brand-border">
        ...
        >
          <div class="flex flex-col md:flex-row md:items-baseline md:justify-between gap-2 mb-3">
            <h2 class="text-lg lg:text-xl font-display font-bold text-brand-dark group-hover:text-brand-violet transition-colors duration-300">
          ...
          <p class="text-sm text-brand-text-secondary leading-relaxed max-w-2xl mb-3">{{ post.description }}</p>
