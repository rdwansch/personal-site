  ...
  >
    ...
    <div class="flex md:hidden gap-4 items-center">
      <NuxtLink
        ...
        :key="link.label"
        :to="link.href"
        class="text-xs font-semibold tracking-widest uppercase text-fg-secondary hover:text-accent transition-colors duration-300"
      ...
      <button
        @click="toggleTheme"
        aria-label="Toggle theme"
        class="w-7 h-7 flex items-center justify-center text-fg-secondary hover:text-accent transition-colors duration-300"
      >
