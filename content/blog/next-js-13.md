...
title: NextJS 13
date: 2022-12-26
description: Beberapa Update tentang NextJS versi 13
tags: [NextJS]
---
...
- `force-cache` hanya akan dijalankan ketika di-_build_ atau mekanisme ini mirip seperti `getStaticProps`.
- `no-store` dijalankan setiap _request_. mirip seperti `getServerSideProps`.
